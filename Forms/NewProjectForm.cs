	...
	public partial class NewProjectForm : Form
	{
		...
		public NewProjectForm(string engine)
		{
			...
			if (engine == "RMXP")
			{
				...
				checkBoxInclude.Text += "RGSS102E.dll";
            }
            else if (engine == "RMVX")
            {
            ...
            else if (engine == "RMVXAce")
            {
                ...
                checkBoxInclude.Text += "RGSS300.dll";
            }
            int id = 0;
            string title;
            do title = "Projet" + (++id).ToString();
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			...
			{
				MessageBox.Show("Le répertoire existe déjà!\nVeuillez choisir un autre chemin.", 
		...
		private void buttonBrowse_Click(object sender, EventArgs e)
		{
			using (FolderBrowserDialog dialog = new FolderBrowserDialog())
			{
                ...
                dialog.Description = "Sélectionnez un répertoire pour créer le nouveau projet.";
